...
*/
const pit = '```'
const XPTN = 'RIDHO'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/ridho_setiawan02'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/6281289096745'; // Nomor whatsapplu cok
const aktif = 'Tergantung jaringan'; // Kapan bot lu aktif
const groupwa = 'https://chat.whatsapp.com/LX1nAiZUuB5FmTCMwe0o4g'; // OFFICIAL GRUP LU 1
const youtube = 'https://www.youtube.com/channel/lowoijo'; // OFFICIAL GRUP LU 2
//
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6281289096745:+62 812-8909-6745\n' // WhatsApp ID + phone number
            + 'END:VCARD'
//
const
{
...
{
   var owner = '6281289096745@s.whatsapp.net'
   var isAdmin = m.participant === owner
   var admin = '6281289096745@s.whatsapp.net'
...
conn.sendMessage(id, 'Owner BARXNL wa.me/6281289096745' ,MessageType.text);
}
else if (text == 'Akbar'){
...
else if (text == '.ttp'){                                                                                                                              conn.sendMessage(id, ' *COMMAND PREMIUM CHAT WA https://wa.me/6281289096745* ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Ya?, Ketik .help/.info/.donasi Contoh .help' ,MessageType.text);
}
